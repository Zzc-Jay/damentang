...
const SCENES = {
  ...
  village_entrance: {
    ...
    elements: [
      ...
      { id: 'hall_door', type: 'door', emoji: '🚪', x: 92, y: 48,
  ...
  ancestral_hall: {
    ...
    elements: [
      ...
      { id: 'stove_switch', type: 'door', emoji: '🗄️', x: 88, y: 55,
  ...
  study: {
    ...
    elements: [
      ...
      { id: 'bedroom_door_study', type: 'door', emoji: '🚪', x: 92, y: 52,
  ...
  bedroom: {
    ...
    elements: [
      ...
      { id: 'wardrobe', type: 'door', emoji: '🚪', x: 75, y: 47,
        ...
        puzzle: {
          ...
          reward: {
            ...
            setFlag: 'wardrobe_pattern_found', hideElement: 'wardrobe'
          }
        }
      },
      ...
      { id: 'basement_door_bedroom', type: 'door', emoji: '🚪', x: 92, y: 52,
  ...
  dark_passage: {
    ...
    elements: [
      ...
      { id: 'wall_carving', type: 'collectible', itemId: 'ritual_text', emoji: '📜', x: 30, y: 35,
        text: '石壁上刻满了古老的文字，上面记载着守门人的誓言和封印的真相。' },
      ...
      { id: 'seal_door', type: 'door', emoji: '🚪', x: 88, y: 48,
